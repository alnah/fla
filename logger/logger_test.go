...
func TestNewTestLoggerInitialState(t *testing.T) {
	tl := NewTestLogger()
	// debug
	if tl.CalledDebug() {
...
func TestTestLoggerMethodsAndCounts(t *testing.T) {
	tl := NewTestLogger()
...
func TestNewSloggerLevelFiltering(t *testing.T) {
	buf := &bytes.Buffer{}
...
func TestSloggerWithContext(t *testing.T) {
	buf := &bytes.Buffer{}
...
func TestDefaultFunctionUsesDefaultLogger(t *testing.T) {
	old := defaultLogger
	buf := &bytes.Buffer{}
