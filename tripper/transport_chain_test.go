...
// TODO: rewrite test with the logic.
...
// 	rt := UseStatusClassifier(ai.APIAnthropic)(next)
...
// 	rt := UseStatusClassifier(ai.APIOpenAI)(next)
// 	_, err := rt.RoundTrip(&http.Request{})

// 	httpErr, ok := err.(*ai.ErrorResponse)
// 	if !ok {
...
// TODO: extract this test where it should go
...
// 			err:       fmt.Errorf("wrap: %w", &ai.ErrorResponse{Type: "baz"}),
// 			want:      true,
// 		},
